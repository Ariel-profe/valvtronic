...
export const Menu = () => {
  ...
  <>
    <div className="burgerHeader">
      <div onClick={() => {setOpen(!open)}} className="burgerButton">
  ...
  <motion.div
    ...
    animate="animate"
    exit="exit"
    className="fixed right-0 top-0 w-full h-screen origin-top bg-gradient-to-r from-slate-900 to-slate-800 p-10 z-40 px-3"
  >
    ...
    <div className="flex h-full flex-col px-3">
      ...
      >
      {links.map(({href, id, name, subMenus}, index) => {
        return (
        <motion.div
          key={id}
