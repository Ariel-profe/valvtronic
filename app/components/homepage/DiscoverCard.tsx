...
export const DiscoverCard:FC<Props> = ({ id, imgUrl, title, subtitle = '', href = '' }) => {
  ...
  if(href){
    return (
      <Link href={href} className="relative w-full flex flex-col items-center justify-center group transition-all bg-gradient-to-r from-primary-blue to-primary-purple">
