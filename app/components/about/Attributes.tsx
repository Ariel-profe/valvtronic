...
export const Attributes = () => {
  return (
    <motion.div
            ...
            className='flex flex-col items-center gap-5 w-full mt-20 p-3'
        >
        <TypingText title="| Nuestros atributos" textStyles="text-center" />
        <TitleText title={<>Esencia y base de nuestra compañía</>} textStyles="text-center" />
