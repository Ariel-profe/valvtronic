...
export const Purpose = () => {
  return (
    <motion.div
      ...
      className={`container mx-auto flex justify-center items-center flex-col lg:my-20`}
    >
      ...
      <motion.p
        ...
        className="mt-10 sm:text-[32px] text-[20px] text-center text-primary-dark-grey max-w-[850px]"
      >
