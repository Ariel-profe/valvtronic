...
export const AttributeCard:FC<Props> = ({desc, img, title, titleStyles, subtitleStyles, iconStyles}) => {
  return (
    <div className="group relative cursor-pointer overflow-hidden dark:bg-gray-700 p-3 ring-1 ring-primary-purple transition duration-700 lg:hover:-translate-y-3 lg:hover:shadow-2xl sm:mx-auto sm:px-10 w-full">
        ...
        <div className="relative z-10 mx-auto max-w-xl">
            <div className="flex flex-col justify-between items-center gap-2">
                {img && (
                    <span className="grid h-20 w-20 lg:h-28 lg:w-28 self-end rounded-full transition-all duration-700">
                ...
                <div>
                    ...
                    <p className={`text-sm lg:text-lg space-y-6 pt-5  leading-7 text-gray-400 transition-all duration-700 lg:group-hover:text-white/9 ${subtitleStyles}`}>{desc}</p>
                </div>
            </div>
        </div>
    </div>
